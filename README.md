...
| 6. Находясь в папке `dir_1`, через команду `cat` создать текстовый файл `tf_2.txt` <br> со следующими строками: - the first 1 - the second 2- the third 3 | `cat > tf_2.txt` <br> the first 1 <br> the second 2 <br> the third 3 |
...
| 26. Найти строки в файлах, содержащие только комбинацию букв “sec” в любом регистре        | `grep -iw "sec" *`                                              |
| 27. Найти строки в файлах, содержащие комбинацию букв “second” в текущей папке             | `grep "second" *`                                               |
| 28. Найти строки в файлах, содержащие комбинацию букв “second” в любом регистре            | `grep -i "second" *`                                            |
...
| 36. Переместить в одну папку текстовые файлы, содержащие слово “sec” в содержимом          | `grep -rl "sec" . *.txt | xargs mv -t folder/`                  |
| 37. Скопировать в одну папку текстовые файлы, содержащие слово “sec” в содержимом          | `grep -rl "sec" . *.txt | xargs cp -t folder/`                  |
| 38. Найти все строки с “sec” и скопировать в новый текстовый файл                         | `grep "sec" *.txt > copied_text.txt`                            |
| 39. Удалить текстовые файлы, содержащие слово “sec” в содержимом                           | `grep -l "sec" *.txt | xargs rm`                                |
